...
- **[Marker-TITO-replacement](https://github.com/g8tsz/Marker-TITO-replacement)** — Paperless ticket/voucher system (cash-out → digital ticket)
- **[Account-system](https://github.com/g8tsz/Account-system)** — Player account + card-in/session + balance (works in parallel with tickets)
